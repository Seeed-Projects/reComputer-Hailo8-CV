...
app = FastAPI(title="reComputer Tiny-YOLOv4 License Plates Hailo-8")
...
@app.post("/api/models/tiny_yolov4_license_plates/predict")
...
async def index():
    ...
    <html><head><title>reComputer License Plate Detection · Hailo-8</title>
    <style>
    ...
    <div class="container"><h1>Tiny-YOLOv4 License Plates · RPi5 + Hailo-8</h1>
...
def main():
    parser = argparse.ArgumentParser(description='Tiny-YOLOv4 license-plate detection on RPi5 + Hailo-8')
