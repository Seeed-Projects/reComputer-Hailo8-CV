...
app = FastAPI(title="reComputer EfficientDet-Lite1 Hailo-8")
...
@app.post("/api/models/efficientdet_lite1/predict")
async def predict(
...
async def index():
    ...
    <html>
      <head>
        <title>reComputer EfficientDet-Lite1 · Hailo-8</title>
        <style>
      ...
      <body>
        <div class="container">
          <h1>EfficientDet-Lite1 · RPi5 + Hailo-8</h1>
          <div class="tabs">
...
# ---------------------------------------------------------------------------
# EfficientDet-Lite1 post-processing (on-chip NMS / HPP)
#
...
def main():
    parser = argparse.ArgumentParser(description='EfficientDet-Lite1 on RPi5 + Hailo-8 (Web Preview Mode)')
