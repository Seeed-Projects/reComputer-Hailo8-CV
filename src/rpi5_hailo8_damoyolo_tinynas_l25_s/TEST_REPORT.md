# Test Report — DAMO-YOLO (tinynasL25_S) on CM5 + Hailo-8

## Model

| Field | Value |
|---|---|
| Model name | damoyolo_tinynasL25_S (slug: damoyolo_tinynas_l25_s) |
| Task | Object detection (COCO 80 classes) |
| Backbone | TinyNAS-L25, Small size |
| Parameters | 16.25M |
| Operations | 37.64G |
...
| Field | Value |
|---|---|
| File | model/damoyolo_tinynas_l25_s.hef |
| Size | ~14 MB (14,400,237 bytes) |
| SHA256 | 79d81c15a3964a7ab475c3a6b91e314084558497cd776bcf9fda6c9cae56858d |
| Source | https://hailo-model-zoo.s3.eu-west-2.amazonaws.com/ModelZoo/Compiled/v2.19.0/hailo8/damoyolo_tinynasL25_S.hef |
| Note | Renamed from Model Zoo name (damoyolo_tinynasL25_S) to lowercase slug for GHCR validity |
...
| Post-processing identical to verified L20_T build (same base config) | Pass |
...
- Same as L20_T: six heads grouped by spatial size + channel count (fewer ch =
  box 68ch, more = cls 81ch), robust to HailoRT dict ordering. First-inference
  log prints every vstream name/shape and the per-scale grouping; verify it
  matches [box80,cls80,box40,cls40,box20,cls20].
