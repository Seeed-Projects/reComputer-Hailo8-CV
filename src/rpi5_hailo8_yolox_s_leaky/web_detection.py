...
# YOLOX-S-Leaky outputs 80 classes (base config: classes=80,
...
app = FastAPI(title="reComputer YOLOX-S-Leaky Hailo-8")
...
@app.post("/api/models/yolox_s_leaky/predict")
async def predict(
...
async def index():
    ...
    <html>
      <head>
        <title>reComputer YOLOX-S-Leaky · Hailo-8</title>
        <style>
      ...
      <body>
        <div class="container">
          <h1>YOLOX-S-Leaky · RPi5 + Hailo-8</h1>
          <div class="tabs">
...
# ---------------------------------------------------------------------------
# YOLOX-S-Leaky post-processing (on-chip NMS / HPP)
#
...
def main():
    parser = argparse.ArgumentParser(description='YOLOX-S-Leaky on RPi5 + Hailo-8 (Web Preview Mode)')
