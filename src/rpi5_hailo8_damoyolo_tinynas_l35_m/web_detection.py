...
app = FastAPI(title="reComputer DAMO-YOLO (tinynasL35_M) Hailo-8")
...
@app.post("/api/models/damoyolo_tinynas_l35_m/predict")
async def predict(
...
async def index():
    ...
    <html>
      <head>
        <title>reComputer DAMO-YOLO (tinynasL35_M) · Hailo-8</title>
        <style>
      ...
      <body>
        <div class="container">
          <h1>DAMO-YOLO (tinynasL35_M) · RPi5 + Hailo-8</h1>
...
#
# The HEF (damoyolo_tinynasL35_M) exposes six FLOAT32 outputs, three scales
...
def main():
    parser = argparse.ArgumentParser(description='DAMO-YOLO (tinynasL35_M) on RPi5 + Hailo-8 (Web Preview Mode)')
