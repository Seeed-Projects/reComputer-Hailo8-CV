...
app = FastAPI(title="reComputer DAMO-YOLO (tinynasL20_T) Hailo-8")
...
@app.post("/api/models/damoyolo_tinynas_l20_t/predict")
async def predict(
...
async def index():
    ...
    <html>
      <head>
        <title>reComputer DAMO-YOLO (tinynasL20_T) · Hailo-8</title>
        <style>
      ...
      <body>
        <div class="container">
          <h1>DAMO-YOLO (tinynasL20_T) · RPi5 + Hailo-8</h1>
...
#
# The HEF (damoyolo_tinynasL20_T) exposes six FLOAT32 outputs, three scales
...
def main():
    parser = argparse.ArgumentParser(description='DAMO-YOLO (tinynasL20_T) on RPi5 + Hailo-8 (Web Preview Mode)')
