# YOLACT RegNetX-1.6GF on Raspberry Pi 5 / CM5 + Hailo-8

This module runs YOLACT-RegNetX-1.6GF instance segmentation (COCO 80 classes,
...
|---|---|---|
| `/api/models/yolact_regnetx_1_6gf/predict` | POST | Detections + per-object mask area (JSON) |
...
(model `yolact_regnetx_1_6gf`, source: [dbolya/yolact](https://github.com/dbolya/yolact)).