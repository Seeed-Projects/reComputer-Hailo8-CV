...
app = FastAPI(title="reComputer YOLACT RegNetX-800MF Hailo-8")
...
@app.post("/api/models/yolact_regnetx_800mf/predict")
async def predict(
...
async def index():
    ...
    <html>
      ...
      <body>
        <div class="container">
          <h1>YOLACT RegNetX-800MF · RPi5 + Hailo-8</h1>
          <div class="tabs">
...
def main():
    parser = argparse.ArgumentParser(description='YOLACT RegNetX-800MF on RPi5 + Hailo-8 (Web Preview Mode)')
