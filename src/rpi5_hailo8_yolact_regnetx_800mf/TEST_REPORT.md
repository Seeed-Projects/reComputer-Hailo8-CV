# Test Report — YOLACT-RegNetX-800MF on CM5 + Hailo-8

## Model

| Field | Value |
|---|---|
| Model name | yolact_regnetx_800mf |
| Task | Instance segmentation (COCO 80 classes) |
| Backbone | RegNetX-800MF (YOLACT, UC Davis) |
| Parameters | 28.3M |
| Operations | 116.75G |
...
| Field | Value |
|---|---|
| File | model/yolact_regnetx_800mf.hef |
| Size | ~35 MB |
| SHA256 | e0a8635e080be28804e2f60272db2d6a85223a2651dce55af8e44c2ee9158ac9 |
| Source | https://hailo-model-zoo.s3.eu-west-2.amazonaws.com/ModelZoo/Compiled/v2.19.0/hailo8/yolact_regnetx_800mf.hef |
