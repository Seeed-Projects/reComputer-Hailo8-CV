# Test Report — YOLOv5s-seg on CM5 + Hailo-8

## Model

| Field | Value |
|---|---|
| Model name | yolov5s_seg |
| Task | Instance segmentation (COCO 80 classes) |
| Architecture | YOLOv5s-seg (anchor-based, 3 anchors x 3 strides) |
| Parameters | 7.61M |
...
| Field | Value |
|---|---|
| File | model/yolov5s_seg.hef |
| Size | 8,710,213 bytes |
| SHA256 | b7403830caa37cc42c8dcbd41eaebfe8f5b4e5b2923d573954b9c485cab81f59 |
| Source | https://hailo-model-zoo.s3.eu-west-2.amazonaws.com/ModelZoo/Compiled/v2.19.0/hailo8/yolov5s_seg.hef |
