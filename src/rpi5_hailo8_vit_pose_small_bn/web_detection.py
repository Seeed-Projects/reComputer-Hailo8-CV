...
app = FastAPI(title="reComputer ViTPose-Small-BN Hailo-8")
...
@app.post("/api/models/vit_pose_small_bn/predict")
...
async def index():
    ...
    <html><head><title>reComputer ViTPose-Small-BN · Hailo-8</title>
    <style>
    ...
    <div class="container"><h1>ViTPose-Small-BN · RPi5 + Hailo-8</h1>
...
# ---------------------------------------------------------------------------
# ViTPose-Small-BN post-processing (heatmap argmax → keypoints → skeleton)
#
...
def main():
    parser = argparse.ArgumentParser(description='ViTPose-Small-BN on RPi5 + Hailo-8')
