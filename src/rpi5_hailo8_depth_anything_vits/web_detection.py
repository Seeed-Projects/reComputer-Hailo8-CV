...
app=FastAPI(title="reComputer Depth-Anything-ViTS Hailo-8")
...
@app.post("/api/models/depth_anything_vits/predict")
...
async def index():
    ...
    <html><head><title>reComputer Depth-Anything-ViTS · Hailo-8</title>
    <style>
    ...
    <div class="container"><h1>Depth-Anything-ViTS · RPi5 + Hailo-8</h1>
...
# ---------------------------------------------------------------------------
# Depth-Anything-ViTS post-processing
#
...
def main():
    parser = argparse.ArgumentParser(description='Depth-Anything-ViTS on RPi5 + Hailo-8')
