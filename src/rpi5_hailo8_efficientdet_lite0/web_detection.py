...
app = FastAPI(title="reComputer EfficientDet-Lite0 Hailo-8")
...
@app.post("/api/models/efficientdet_lite0/predict")
async def predict(
...
async def index():
    ...
    <html>
      <head>
        <title>reComputer EfficientDet-Lite0 · Hailo-8</title>
        <style>
      ...
      <body>
        <div class="container">
          <h1>EfficientDet-Lite0 · RPi5 + Hailo-8</h1>
          <div class="tabs">
...
# ---------------------------------------------------------------------------
# EfficientDet-Lite0 post-processing (on-chip NMS / HPP)
#
...
def main():
    parser = argparse.ArgumentParser(description='EfficientDet-Lite0 on RPi5 + Hailo-8 (Web Preview Mode)')
