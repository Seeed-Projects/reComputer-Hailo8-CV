# CenterNet (resnet_v1_18) on Raspberry Pi 5 / CM5 + Hailo-8

This module runs CenterNet object detection (ResNet-18 backbone, COCO 80
classes) with the on-chip `max_finder` post-processing variant. The FastAPI
