...
app = FastAPI(title="reComputer CenterNet (resnet_v1_18) Hailo-8")
...
@app.post("/api/models/centernet_resnet_v1_18_postprocess/predict")
async def predict(
...
async def index():
    ...
    <html>
      <head>
        <title>reComputer CenterNet (resnet_v1_18) · Hailo-8</title>
        <style>
      ...
      <body>
        <div class="container">
          <h1>CenterNet (resnet_v1_18) · RPi5 + Hailo-8</h1>
...
#
# The HEF (centernet_resnet_v1_18_postprocess) exposes three FLOAT32 outputs,
...
def main():
    parser = argparse.ArgumentParser(description='CenterNet (resnet_v1_18_postprocess) on RPi5 + Hailo-8 (Web Preview Mode)')
