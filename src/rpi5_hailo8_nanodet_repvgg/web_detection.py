...
app = FastAPI(title="reComputer NanoDet-RepVGG Hailo-8")
...
@app.post("/api/models/nanodet_repvgg/predict")
async def predict(
...
async def index():
    ...
    <html>
      <head>
        <title>reComputer NanoDet-RepVGG · Hailo-8</title>
        <style>
      ...
      <body>
        <div class="container">
          <h1>NanoDet-RepVGG · RPi5 + Hailo-8</h1>
          <div class="tabs">
...
# ---------------------------------------------------------------------------
# NanoDet-RepVGG post-processing (on-chip NMS / HPP)
#
...
def main():
    parser = argparse.ArgumentParser(description='NanoDet-RepVGG on RPi5 + Hailo-8 (Web Preview Mode)')
